...
class Server(BaseServer):
    ...
    def save_best_results(self):
        ...
        if self._cfg.llm.merge_to != '' and self.ds_rank == 0:
            self.aggregator.save_model_for_inference(self._cfg.llm.merge_to, self._cfg.model.type.split('@')[0])
        elif self._cfg.federate.save_to != '' and self.ds_rank == 0:
